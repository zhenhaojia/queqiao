...
-- 插入一些预算分类示例
INSERT INTO budgets (wedding_id, category, allocated_amount, spent_amount, description) VALUES
('00000000-0000-0000-0000-000000000000', '摄影摄像', 15000, 0, '婚礼摄影和录像'),
('00000000-0000-0000-0000-000000000000', '场地布置', 30000, 0, '婚礼场地装饰'),
('00000000-0000-0000-0000-000000000000', '服装造型', 10000, 0, '新娘新郎服装和化妆'),
('00000000-0000-0000-0000-000000000000', '餐饮服务', 20000, 0, '婚宴餐饮'),
('00000000-0000-0000-0000-000000000000', '其他费用', 5000, 0, '其他杂项费用');

-- 插入一些任务示例
INSERT INTO tasks (wedding_id, title, description, due_date, status, priority) VALUES
('00000000-0000-0000-0000-000000000000', '确定婚礼场地', '实地考察并确定最终婚礼场地', '2024-02-01', 'todo', 'high'),
('00000000-0000-0000-0000-000000000000', '预订摄影团队', '联系并预订婚礼摄影服务', '2024-02-15', 'todo', 'medium'),
('00000000-0000-0000-0000-000000000000', '发送邀请函', '制作并发送婚礼邀请函给嘉宾', '2024-03-01', 'todo', 'medium'),
('00000000-0000-0000-0000-000000000000', '最终确定婚礼流程', '与各方确认婚礼当天详细流程', '2024-03-15', 'todo', 'high');